...
/**
 * _mysetenv - this intialize a new environment variable,
 * or modify an existing one
 * @info: this structure containing potential arguments
 * Return: Always 0
 */
int _mystenv(info_t *info)
{
	if (info=->argc != 3)
	{
 ...
 * @info: this structure containing potential arguments. used to maintain function prototype
 * Return: Always 0
 */
